  ...
  "Standard Apartment Cleaning": {
    ...
    sections: [
      ...
      },
      {
        ...
        items: ["Clean and rearrange the patio set", "Sweep and mop the floor"],
      },
    ],
  },
  ...
  "Apartment Deep Cleaning": {
    ...
    sections: [
      ...
      },
      {
        ...
        items: ["Steam and scrub bathtubs or showers"],
      },
      {
      ...
      },
      {
        ...
        items: ["Deep clean two bed mattresses"],
      },
      {
        title: "Changing & Ironing Bed Sheets",
        items: ["Iron and change bedsheets for both bedrooms"],
      },
      {
        title: "Skirting Board Cleaning",
        items: ["Wipe all skirting boards throughout the apartment"],
      },
      {
        title: "Balcony Cleaning",
        items: [
...
function ServiceDetailsContent() {
  ...
  const category =
    searchParams.get("category") || "Standard Apartment Cleaning";
  const details =
    serviceDetails[category] || serviceDetails["Standard Apartment Cleaning"];
              ...
              >
                ...
                <ul className="space-y-3 ml-14">
                  {section.items.map((item, itemIndex) => (
                    ...
                    >
                      <span className="text-[#2563EB] font-bold mt-1 flex-shrink-0">
                        ✓
                      </span>
          ...
          <div className="mt-12 pt-8 border-t border-[#D1D5DB]">
            <div className="bg-[#EFF6FF] rounded-xl p-6 text-center border border-[#2563EB]">
              ...
              <p className="text-[#6B7280] mb-6">
                Get started by selecting this service and booking your preferred
                date
              </p>
              <Link
